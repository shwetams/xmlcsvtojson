   ...
   public class XMLToJSON
    {
        ...
        public  string ProcessCSVFile(string csvfilename, bool isFirstRowHeader)
        {
            string jsonString = "{\"csvvalues\":[";
            var dataTable = CSVReader.ReadCSVFile(csvfilename, isFirstRowHeader);
